...
function sendkeys(env, args, done) {
    try {
...
function wtester(name, starter, opts, exec) {
    ...
    var browser = new webdriver.Builder()
        .withCapabilities(new webdriver.Capabilities(opts.conf.capabilities))
    ...
    function wtester_js_h(req, res) {
        ...
        res.write("new jswf.wtester(" + opts.conf.port + ").start();", "utf-8");
        res.end();
